        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="images/logo/MyTransporter PNG.png" alt="">
			</a>
        </div>
        <!--**********************************
            Nav header end
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a href="customer.html" class="ai-icon" aria-expanded="false">
						<i class="fa fa-user-circle-o" aria-hidden="true"></i>
						<span class="nav-text">Riders</span>
					</a>
					</li>
                    <li><a class="ai-icon" href="order-list.html" aria-expanded="false">
						<i class="flaticon-043-menu"></i>
							<span class="nav-text">Orders</span>
						</a>
                    </li>
                    <li>
						<a class="ai-icon" href="transactions.html" aria-expanded="false">
							<i class="fa fa-money" aria-hidden="true"></i>
							<span class="nav-text">Payment</span>
						</a>
                    </li>
					<li>
						<a class="ai-icon" href="settings.html" aria-expanded="false">
						<i class="fa fa-cog" aria-hidden="true"></i>
							<span class="nav-text">Settings</span>
						</a>
                    </li>
                    <li><a class="ai-icon" href="rate_settings.html" aria-expanded="false">
						<i class="fa fa-cogs" aria-hidden="true"></i>
							<span class="nav-text">Rate Settings</span>
						</a>
                    </li>
